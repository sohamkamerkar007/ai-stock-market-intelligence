...
An end-to-end MSc Data Analytics research platform for Indian equities: reproducible market-data ingestion, leakage-aware features, supervised direction models, unsupervised market regimes, contextual ablation studies, news sentiment, anomaly detection, SHAP explanations, time-aware backtests, a FastAPI API/WebSocket layer, and a framework-free financial-terminal UI.
